...
function SE03Lite() {
    ...
    useEffect(() => {
        ...
        function showNextImage() {
            images[currentImageIndex.current].style.opacity = 0;

            currentImageIndex.current =
                (currentImageIndex.current + 1) % totalImages;

            images[currentImageIndex.current].style.opacity = 1;
        }
            ...
            <div className="carousel-division">
                <div className="carousel">
                    <div className="carousel-images">
                        <img ref={(el) => imagesRef.current[0] = el} src={black} alt="" style={{ opacity: 1 }} />
                        <img ref={(el) => imagesRef.current[1] = el} src={red} alt="" style={{ opacity: 0 }} />
                        <img ref={(el) => imagesRef.current[2] = el} src={black} alt="" style={{ opacity: 0 }} />
                    </div>
                </div>
            </div>
